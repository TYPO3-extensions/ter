 ...
 *
 * /usr/bin/php5 {fullpath...}/process-extension-download-logs_cli.php -u terdevtestmirror -p terdevemptypassword -l
 * /var/log/access_log -w http://ter.dev.robertlemke.de/wsdl/tx_ter_wsdl.php
 *
